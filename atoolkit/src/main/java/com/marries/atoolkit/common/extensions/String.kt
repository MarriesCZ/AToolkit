...
import com.marries.atoolkit.application
...
fun String.isPhone(): Boolean = Patterns.PHONE.matcher(this).matches()
...
fun String.isIDCard15(): Boolean = REGEX_ID_CARD_15.toRegex().matches(this)
